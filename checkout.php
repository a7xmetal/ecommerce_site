...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/bass.jpg) no-repeat scroll center center / cover ;">
										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method">
													...
													&nbsp;&nbsp;Khalti <input type="radio" name="payment_type" value="payu" required/>
												</div>
												<div class="single-method">
